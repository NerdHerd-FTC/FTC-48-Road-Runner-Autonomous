 ...
 */
@Config
public class MecanumDrivebaseInstance extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 1.4357376538401620190060757127278;

    public static double VX_WEIGHT = 1;
    public static double VY_WEIGHT = 1;
    public static double OMEGA_WEIGHT = 1;

    private static TrajectorySequenceRunner trajectorySequenceRunner;
    ...
    public MecanumDrivebaseInstance(HardwareMap hardwareMap) {
    ...
    public static void followTrajectoryAsync(Trajectory trajectory) {
        trajectorySequenceRunner.followTrajectorySequenceAsync(
