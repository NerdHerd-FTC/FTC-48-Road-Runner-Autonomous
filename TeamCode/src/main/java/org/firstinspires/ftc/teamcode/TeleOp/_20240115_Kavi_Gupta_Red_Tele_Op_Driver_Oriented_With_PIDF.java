...
@TeleOp
public class _20240115_Kavi_Gupta_Red_Tele_Op_Driver_Oriented_With_PIDF extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.left_trigger > 0.1) {
                ...
                TrajectorySequence Move_Robot_To_Pickup_Pixel = MecanumDrivebase.trajectorySequenceBuilder(Current_Robot_Pose)
                ...
                boolean isRobotMovingToPickupPixel = true;
            ...
            telemetry.addData("Heading (deg): ", Math.toRadians(Current_Robot_Heading));
            telemetry.update();
        }
    }
}
