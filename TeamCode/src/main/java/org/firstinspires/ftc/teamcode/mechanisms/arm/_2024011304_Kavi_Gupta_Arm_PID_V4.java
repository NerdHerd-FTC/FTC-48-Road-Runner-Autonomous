...
@Config
@TeleOp
public class _2024011304_Kavi_Gupta_Arm_PID_V4 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            UpdateArmPositionWithPIDF();
        }
    }

    public void UpdateArmPositionWithPIDF() {
        //Active code
        Arm_PID_Controller.setPID(P_Coefficient, I_Coefficient, D_Coefficient);

        int Arm_Current_Position = Arm_Motor.getCurrentPosition();
        ...
        if (Math.abs(Arm_Positional_Error) > Arm_Motor_Tolerance) {
            ...
            telemetry.addData("Arm Current Position: ", Arm_Current_Position);
            telemetry.addData("Arm Calculated Power: ", Calculated_Power_For_Arm_Motor);
            telemetry.update();
        }
    }
}
