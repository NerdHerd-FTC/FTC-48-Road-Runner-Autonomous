...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double mecTransP = MecanumDrivebaseInstance.TRANSLATIONAL_PID.kP;
        public double mecTransI = MecanumDrivebaseInstance.TRANSLATIONAL_PID.kI;
        public double mecTransD = MecanumDrivebaseInstance.TRANSLATIONAL_PID.kD;
        public double mecHeadingP = MecanumDrivebaseInstance.HEADING_PID.kP;
        public double mecHeadingI = MecanumDrivebaseInstance.HEADING_PID.kI;
        public double mecHeadingD = MecanumDrivebaseInstance.HEADING_PID.kD;
        public double mecLateralMultiplier = MecanumDrivebaseInstance.LATERAL_MULTIPLIER;
