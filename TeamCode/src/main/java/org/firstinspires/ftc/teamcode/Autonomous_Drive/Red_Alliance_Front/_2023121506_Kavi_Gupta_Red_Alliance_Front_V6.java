...
public class _2023121506_Kavi_Gupta_Red_Alliance_Front_V6 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence PlacePixelOnRightSpike = MecanumDrivebaseInstance.trajectorySequenceBuilder(MoveToPropScanningLocation.end())
                .back(18)
                .turn(Math.toRadians(-90))
                .back(4)
                .addTemporalMarker(() -> {
        ...
        TrajectorySequence PlaceYellowPixelOnCenterBackDrop = MecanumDrivebaseInstance.trajectorySequenceBuilder(PlacePixelOnCenterSpike.end())
        ...
        TrajectorySequence PlaceYellowPixelOnLeftBackDrop = MecanumDrivebaseInstance.trajectorySequenceBuilder(PlacePixelOnLeftSpike.end())
                .UNSTABLE_addTemporalMarkerOffset(0.5, () -> {
                    Arm.moveArmTo(ArmMovementValue);
                })
                .setVelConstraint(MecanumDrivebaseInstance.getVelocityConstraint(8, 8, DriveConstants.TRACK_WIDTH))
        ...
        TrajectorySequence FailsafePark = MecanumDrivebaseInstance.trajectorySequenceBuilder(MoveToPropScanningLocation.end())
                .forward(3)
                .strafeLeft(40)
                .build();
